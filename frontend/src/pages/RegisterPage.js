  ...
  return (
    <section class="mt-20 flex justify-center items-center w-[80%] mx-auto">
      <div class="flex flex-col gap-5 w-[100%] ">
        ...
        <div class="inputContainer border-[1px] rounded relative border-secondaryColor focus-within:outline-none focus-within:border-primaryColor  w-[100%] h-[52px] mt-4">
          <input
        ...
        <div class="inputContainer border-[1px] rounded relative border-secondaryColor focus-within:outline-none focus-within:border-primaryColor  w-[100%] h-[52px]">
          <input
            class="appearance-none absolute pl-3 top-0 left-0 focus:outline-none w-[100%] h-[100%] login-input bg-transparent"
            type="email"
            placeholder=" "
