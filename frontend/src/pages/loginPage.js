  ...
  return (
    <section class="mt-16 flex justify-center items-center w-[80%] mx-auto">
      <div class="flex flex-col gap-5 w-[100%] ">
        ...
        <div class="login-input-container mt-4 border-[1px] rounded relative border-secondaryColor focus-within:outline-none focus-within:border-primaryColor  w-[100%] h-[52px]">
          <input
        ...
        <div class="login-input-container border-[1px] rounded relative border-secondaryColor focus-within:outline-none focus-within:border-primaryColor  w-[100%] h-[52px]">
          <input
            class="appearance-none absolute pl-3 top-0 left-0 focus:outline-none w-[100%] h-[100%] login-input bg-transparent"
            type="password"
            placeholder=" "
        ...
        <button
          class="h-[52px] bg-primaryColor w-[100%] rounded border-transparent text-white text-[18px] font-medium"
          type="submit"
        >
          Register
        </button>
        <span class=" text-center">
          ...
          <span class="text-primaryColor">Register here</span>
        </span>
      </div>
    </section>
  );
