...
export const ProductDetailsPage = () => {
  ...
  const { _id, title, price, image, discountPercentValue, categories } = currentProduct;
    ...
    <>
      ...
      <section className="className mt-16 mb-32 w-[90%] mx-auto gap-6 flex flex-col ">
        <div className="w-[100%] h-[320px] mx-auto bg-[#e5e5e5] relative flex justify-center items-center">
          <img src={image} alt="" className="w-[100%] max-w-[95%] h-auto max-h-[95%] object-cover" />
          <div
        ...
        <div className="flex gap-1">
          <h3 className="font-bold tracking-[0.5px] text-[18px]">Availability :</h3>
          <span> Out of stock</span>
        </div>
        <div>
          <h2 className="font-bold text-[18px] tracking-[0.5px]">Description</h2>
          <p className="leading-[150%]">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Asperiores ut voluptatem vitae, temporibus fugit
            velit voluptate ea enim voluptas. Fugit?. Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus
            amet excepturi unde voluptatum obcaecati dolorum vel numquam totam soluta inventore.
          </p>
        </div>
        ...
        <div className="flex-col flex gap-4">
          <h3 className="font-bold text-[18px] tracking-[0.5px]">Shipping Options</h3>
          <span className="font-bold text-[18px] text-[#fca311]">*This product is eligible for Free Shipping</span>
          <div className="flex flex-col gap-2">
            <p className=" leading-[150%]">
              <text className="font-semibold">Standard shipping</text>(Delivery in 5-7 working days) - takes 5% of
              product's total amount.
            </p>
            <p className="leading-[150%]">
              <text className="font-semibold">Free shipping</text>(Delivery in 5-7 working days) - takes 0% of total
              product's amount.
            </p>
            {/* <p className=" leading-[150%]">
