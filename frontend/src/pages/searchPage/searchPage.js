    ...
    <section className="lg:grid lg:grid-cols-[250px_1fr_1fr_1fr] lg:grid-rows-[auto_1fr_auto]">
      ...
      <div className="lg:col-start-2 lg:col-end-5 lg:row-span-1 lg:ml-[8%] xl:ml-[10%] lg:mr-[3%] xl:mr-[5%]">
        ...
        {searchedProductData.length < 1 ? (
          ...
          <>
            <article className="w-[65%] tablet:w-[40%] md:w-[30%] bg-[#ffffff] laptop:w-[40%] lg:w-[30%] ml-[4%] tablet:ml-[6%]  mb-12 flex-col flex gap-2 lg:ml-0 lg:max-w-[262px]">
            ...
            {(selectedSubCategoryForFilter || priceRange) && (
              <article className="w-[300px] max-w-[75%]  bg-[#ffffff] laptop:w-[40%] lg:w-[30%] lg:max-w-[262px] ml-[4%] tablet:ml-[6%] lg:ml-0 xl:ml-[4%] mb-12 flex-col flex gap-2 ">
